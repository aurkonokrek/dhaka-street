-- =====================================================================
-- Dhaka Street — Complete Backend & CRM Setup
-- Run this once in the Supabase SQL Editor to set up ALL tables,
-- storage buckets, RPC functions, triggers, and security policies from scratch.
-- =====================================================================
...
BEGIN
  ...
  -- Automatically grant admin role to target admin email
...
-- ---------- 4. Dhaka Street Main Content Tables ---------------------
...
-- ---------- 8. Booking Notifications Trigger -------------------------
...
-- ---------- 10. Default Seeding --------------------------------------
-- Sane default availability bookable windows (Mon–Fri, 09:00–12:00, 14:00–17:00).
...
-- ---------- 12. Manual Admin Bootstrapping --------------------------
-- Explicitly insert the user role if the auth user has already been created.
INSERT INTO public.user_roles (user_id, role)
